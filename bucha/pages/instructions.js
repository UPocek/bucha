    ...
    return (
        <>
            ...
            <main className={`${styles.main} ${arimo.className}`}>
                ...
                <Step title={'Dodajte šećer'} number={'5'} text={'Naredni korak je da našem Scoby-u pripremimo hranu za narednih nedelju dana. Scoby se hrani šećerom iz čaja i koristi ga za fermentaciju Kombuhe, tako da usuštini nakon 7 dana gotovo sav šećer koji sada dodate će nestati. Potrebno je da u čaj sipate 60 grama šećera po litri Kombuhe koju pripremate, tako da ukoliko imate teglu od 4 litre biće vam potrebno 240 grama šećera. Koji šećer ćete koristiti je sve jedno i crni i beli šećer su skroz ok više je stvar kako ste vi navikli. Nakon što ste dodali šećer u teglu dobro ga promešajte da se potpuno rastvori.'} order={'1'} />
