...
export default function Shop() {
    ...
    const t = useTranslations('storefront.shop');
    const productTranslations = useTranslations('products.names');
    const products = ['scoby', 'hibiscus', 'cottonCover', 'thermometer'].map((productId) => ({
        productId,
    ...
    return (
        <>
            <SeoHead title={title} description={description} pathname="/prodaja" structuredData={structuredData} />
            <NavWrapper />
            <main
                role="main"
