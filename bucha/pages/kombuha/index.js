...
export default function Kombuha() {
    const title = "Prodaja Kombuhe u Raznim Zabavnim Ukusima"
    const description = "Kombuha prodaja u raznim ukusima po najboljim cenama u Srbiji. Poručite online vaš zdravi kombucha čaj, napitak sa bucha.rs"
    const products = [
        {
