    ...
    return (
        <>
            ...
            <main className={`${styles.main} ${arimo.className}`}>
                ...
                <Step title={'Uživajte'} number={'5'} text={'Ukoliko je sve prošlo kako treba, uspeli ste, napravili ste vašu prvu super sjajnu bajnu Komuhu. Čestitamo! Nadamo se da ste uživali, da su vam naša uputstva pomogla i da ste naučili nešto novo. Sada je red na vas da budete kreativni, eksperimentišite sa dužinom trajanja faza i različitim ukusima. Sigurni smo da ćete pronaći pravu kombinaciju ukusa koja vama odgovara. Sve vaše eksperimente podelite sa nama uz heshtag #buchaizazov i podelićemo vaše rezultate na našim društvenim mrežama. Podelite pozitivnu energiju i videćete kako se osmeh pojavljuje na licima ljudi u vašoj okolini. Puno sreće u daljem igranju želi vam bucha.rs tim. '} order={'1'} />
                <TeamSection />
            </main>
            <Footer />
        </>
