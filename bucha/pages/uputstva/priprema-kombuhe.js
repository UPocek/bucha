    ...
    return (
        <>
            ...
            <main role="main" className={`${styles.main} ${arimo.className}`}>
                ...
                <Step title={'Šta sada?'} number={'8'} text={'Znamo da je ovo mnogima prvi put da prave kombuhu, zato predpostavljamo da imate još gomilu pitanja za nas 😄. Pokušali smo na što više njih da damo odgovore, tako da ako vas interesuje nešto od ovih tema bacite pogled:'} order={'1'} />
                <Related />
